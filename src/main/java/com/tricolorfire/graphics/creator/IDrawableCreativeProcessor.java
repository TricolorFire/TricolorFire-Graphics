...
public interface IDrawableCreativeProcessor<T extends IDrawable> {
	 ...
	 */
	public IDrawable initTempCreate(DrawableCreatorContext context) ;
	 ...
	 * <br/>
	 * <b style="color:red">注:当isCompleted()方法返回true时: 临时层中的图像就会被销毁</b>
	 * 
	 * @param context
	 */
	default IDrawable tempCreate(DrawableCreatorContext context) {return null;}
